...
<?php
    ...
    $date = date("Y-m-d");
    if(empty($Start)){
        echo "<b style='color:red;width:100%;text-align:center;' class='px-2'>Dars boshlanish vaqtini kiriting.</b><br>";
    }elseif(empty($End)){
        echo "<b style='color:red;width:100%;text-align:center;' class='px-2'>Dars yakunlanish vaqtini kiriting.</b><br>";
    }elseif($Start>$End){
        echo "<b style='color:red;width:100%;text-align:center;' class='px-2'>Dars Boshlanish vaqti yakunlanish vaqtidan kichik.</b><br>";
        echo "<b style='color:red;width:100%;text-align:center;' class='px-2'>Darslar vaqtini to'g'irlang.</b>";
    }elseif($Start===$End){
        echo "<b style='color:red;width:100%;text-align:center;' class='px-2'>Dars boshlanish vaqti va yakunlanish vaqti bir xil.</b><br>";
        echo "<b style='color:red;width:100%;text-align:center;' class='px-2'>Darslar vaqtini to'g'irlang.</b>";
    }elseif($Start<$date){
        ...
        <select class='form-control mt-0' name='Dushanba' style='border-radius:0;' required>
        ...
        <select class='form-control mt-0' name='Seshanba' style='border-radius:0;' required>
            <option value='NULL'>Tanlang</option>";
        ...
        <select class='form-control mt-0' name='Chorshanba' style='border-radius:0;' required>
            <option value='NULL'>Tanlang</option>";
            foreach ($clock as $val2ue) { 
        ...
        <select class='form-control mt-0' name='Payshanba' style='border-radius:0;' required>
            <option value='NULL'>Tanlang</option>";
            foreach ($clock as $val2ue) { 
        ...
        <select class='form-control mt-0' name='Juma' style='border-radius:0;' required>
            <option value='NULL'>Tanlang</option>";
            foreach ($clock as $val2ue) { 
        ...
        <select class='form-control mt-0' name='Shanba' style='border-radius:0;' required>
            <option value='NULL'>Tanlang</option>";
            foreach ($clock as $val2ue) { 
