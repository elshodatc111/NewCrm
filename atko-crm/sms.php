    ...
    <section class="section contact">
        <div class="col-lg-12 col-12">
            <div class="info-box card px-2">
                <h5 class="card-title w-100 text-center pb-0 mb-1">Yuborilgan SMS</h5>
                    ...
                    <table  class="table table-bordered text-center align-baseline table-striped" style="font-size:14px;" id="dataTable" width="100%" cellspacing="0">
                        <thead>
                            <tr class="align-middle">
                                ...
                                <th style="background-color: blue;color:white">SMS matni</th>
                                <th style="background-color: blue;color:white">Telefon raqam</th>
                                <th style="background-color: blue;color:white">Yuborilgan vaqt</th>
                            </tr>
                        </thead>
                        <tbody>
                          <?php
