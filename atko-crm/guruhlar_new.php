...
<body>
  ...
  <?php
    $menu = "Guruhlar";
    $blok = "GuruhShow";
    $submenu = "yangiguruhlar";
    include("./connect/menu.php");
  ?>
  
  <main id="main" class="main">
    <div class="pagetitle">
      <h1>Yangi guruhlar</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          <li class="breadcrumb-item active">Yangi guruhlar</li>
        </ol>
      </nav>
    </div>
    <section class="section contact">
        <div class="col-lg-12 col-12">
            <div class="info-box card px-3">
                <h5 class="card-title w-100 text-center pb-0 mb-1">Yangi guruhlar</h5>
                    ...
                    <table  class="table table-bordered text-center align-baseline table-striped" style="font-size:14px;" id="dataTable" width="100%" cellspacing="0">
                      ...
                      <tbody>
                        <?php
                          ...
                          if($i===1){
                            echo "<tr><td colspan=7 class='text-center'>Yangi guruhlar mavjud emas</td></tr>";
                          }
                        ?>
