...
<aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav" id="sidebar-nav">
      <li class="nav-item">
        <a class="nav-link <?php if($menu!='Home'){echo "collapsed";} ?>" href="index.php">
          <i class="bi bi-grid"></i>
          <span>Bosh sahifa</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link <?php if($menu!='Tashriflat'){echo "collapsed";} ?>" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-person-lines-fill"></i><span>Tashriflar</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="components-nav" class="nav-content collapse <?php if($blok==='ShowTashrif'){echo "show";} ?>" data-bs-parent="#sidebar-nav">
          <li>
      ...
      <li class="nav-item">
        <a class="nav-link <?php if($menu!='Guruhlar'){echo "collapsed";} ?>" data-bs-target="#forms-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-journal-text"></i><span>Guruhlar</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="forms-nav" class="nav-content collapse <?php if($blok==='GuruhShow'){echo "show";} ?>" data-bs-parent="#sidebar-nav">
          <li>
            <a href="guruhlar_plus.php" class="
              <?php if($submenu==='guruhPlus'){
                echo "active";
              } ?>"  
              style='display:<?php 
              if($UIns==='off'){echo "none;'";}
              elseif($Type==='mexmon'){echo "none;'";} 
              ?>'>
...
-->
      ...
      <?php  // Hisobot
        if(isset($_COOKIE['UserID'])){
          if($Type==='mexmon'){echo "none;'";}
          elseif($Type==='meneger'){echo "none;'";}
        }
      ?>'>
        <a class="nav-link <?php if($menu!='Hisobot'){echo "collapsed";} ?>" href="hisobot.php">
      ...
      ?>>
        <a class="nav-link <?php if($menu!='Statistika'){echo "collapsed";} ?>" data-bs-target="#charts-nav" data-bs-toggle="collapse" href="#">
      ...
      <li class="nav-item">
        <a class="nav-link <?php if($menu!='Moliya'){echo "collapsed";} ?>" data-bs-target="#icons-nav" href="./moliya.php">
          <i class="bi bi-gem"></i><span>Moliya</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link <?php if($menu!='Techer'){echo "collapsed";} ?>" href="./oqituvchi.php">
      ...
      ?>>
        <a class="nav-link <?php if($menu!='Hodimlar'){echo "collapsed";} ?>" href="./hodimlar.php">
      ...
      ?>>
        <a class="nav-link <?php if($menu!='Xonalar'){echo "collapsed";} ?>" href="xonalar.php">
      ...
      ?>>
        <a class="nav-link <?php if($menu!='Eslatmalar'){echo "collapsed";} ?>" href="eslatma.php">
      ...
      ?>>
        <a class="nav-link <?php if($menu!='SMS'){echo "collapsed";} ?>" href="sms.php">
