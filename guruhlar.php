...
<head>
  ...
  <script>
    <?php
      if(isset($_GET['newguruhplus'])){echo "alert('Yangi guruh ochildi')";}
    ?>
  </script>
</head>
                  ...
                  <table  class="table table-bordered text-center align-baseline table-striped" id="dataTable" width="100%" cellspacing="0" style="font-size:14px;">
                      <thead>
                        <tr class='align-middle'>
                          ...
                          <th style='background-color: blue;color:white'>Guruh holati</th>
                      ...
                      <tbody>
                        <?php
                          ...
                          while($row = $res->fetch()){
                            ...
                            $date = date("Y-m-d");
                            if($End<$date){
                              $Status = "<b class='text-danger p-1'>END</b>";
                            }elseif($Start<=$date){
                              $Status = "<b class='text-success p-1'>START</b>";
                            }else{
                              $Status = "<b class='text-primary p-1'>NEW</b>";
                            }
                          ...
                          if($i===1){
                            echo "<tr><td colspan=8 class='text-center'>Guruhlar mavjud emas</td></tr>";
                          }
                        ?>
