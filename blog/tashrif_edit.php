...
<head>
  ...
  <title>Talaba ma`lumotlarini taxrirlash</title>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="../tashriflar.php">Tashriflar</a></li>
          <li class="breadcrumb-item active">Talaba ma`lumotlarini taxrirlash</li>
        </ol>
      </nav>
    </div>
            ...
            <div class="col-lg-6">
                <div class="info-box card ">
                  <?php
                    ...
                    $row = $res->fetch();
                  ?>
                  <form action="../config/talaba/talaba_edet.php?UserID=<?php echo $_GET['UserID']; ?>" method="POST">
                    <div class="row mb-1">
                      <label for="inputText" class="col-12 col-form-label">FIO</label>
                      <div class="col-sm-12">
                        <input type="text" class="form-control" name="FIO" value="<?php echo $row['FIO']; ?>" required style="border-radius:0;">
                      </div>
                    </div>
                    <div class="row mb-1">
                      <label for="inputEmail" class="col-12 col-form-label">Telefon raqami</label>
                      <div class="col-sm-12">
                        <input type="text" class="form-control phone" name="Phone" value="<?php echo $row['Phone']; ?>" required style="border-radius:0;">
                      </div>
                    </div>
                    <div class="row mb-1">
                      <label for="inputText" class="col-12 col-form-label">Tanishi</label>
                      <div class="col-sm-12">
                        <input type="text" class="form-control" name="Tanish" value="<?php echo $row['Tanish']; ?>" required style="border-radius:0;">
                      </div>
                    </div>
                    <div class="row mb-1">
                      <label for="inputText" class="col-12 col-form-label">Tanishi telefon raqami</label>
                      <div class="col-sm-12">
                        <input type="text" class="form-control phone" name="TPhone" value="<?php echo $row['TanishPhone']; ?>" required style="border-radius:0;">
                      </div>
                    </div>
                    <div class="row mt-2">
                      <div class="col-sm-12">
                        <button type="submit" class="w-100 btn btn-primary" style="border-radius:0;">O'zgarishlarni saqlash</button>
                      </div>
                    </div>
                  </form>
                </div>
