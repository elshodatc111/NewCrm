  ...
  <main id="main" class="main">
    ...
    <section class="section contact">
      <div class="row">
        ...
        <div class="col-lg-2 col-4 py-2">
          <a href="./hisobot_techer.php" class="btn btn-success w-100" style="border-radius:0;">O'QITUVCHI</a>
        </div>
        <div class="col-lg-2 col-4 py-2">
      ...
      <div class="col-lg-12 col-12">
        <div class="card ">
          <form action="hisobot_techer.php?tashrif=true" method="POST">
            <div class="row px-2">
              <div class="col-lg-6 py-2">
                <select name="typing" class="form-select" required style="border-radius:0;">
                  ...
                  <option value="Oqituvchi_guruhlari">O'qituvchi guruhlari</option>
                </select>
              </div>
              <div class="col-lg-6 py-2">
                <button class="btn btn-success w-100" name="filter" style="border-radius:0;">FILTER</button>
              </div>
            </div>
          </form>
        </div>
        <div class="table-responsive" style="display:<?php if(!isset($_POST['filter'])){echo 'none';} ?>">
          <ol class="breadcrumb">
          ...
          <?php
            ...
            ?>
              <table class='table text-center align-baseline' id='table' style='font-size:12px;'>
                ...
                <tbody>
                  <?php
                    $sql1 = "SELECT * FROM `users` JOIN `user_techer` ON users.UserID=user_techer.UserID";
            ...
            <table class='table text-center align-baseline' id='table' style='font-size:12px;'>
              ...
              <tbody>
                <?php
                  $sql2 = "SELECT * FROM `user_techer_tulov` JOIN `users` ON user_techer_tulov.TecherID=users.UserID JOIN `guruh` ON user_techer_tulov.GuruhID=guruh.GuruhID";
                  ...
                  while ($row2=$res2->fetch()) {
                    echo "<tr>
                      <td>".$i."</td>
                      <td>".$row2['FIO']."</td>
                      <td>".$row2['GuruhName']."</td>
                      <td>".$row2['TulovType']."</td>
                      <td>".$row2['TulovSumma']."</td>
                      <td>".$row2['Data']."</td>
                      <td>".$row2['Izoh']."</td>
                    </tr>";
                    $i++;
            ...
            <?php
            }elseif($_POST['typing']==='Oqituvchi_guruhlari'){
            ?>
            <table class='table text-center align-baseline' id='table' style='font-size:12px;'>
              <thead>
                <tr>
              ...
              <tbody>
                <?php
                  $sql3 = "SELECT * FROM `guruh` JOIN `users` ON guruh.TecherID=users.UserID";
