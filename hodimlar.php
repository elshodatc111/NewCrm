...
<head>
  ...
  <link href="https://cdn.datatables.net/1.10.18/css/dataTables.bootstrap4.min.css" rel="stylesheet">
    <script>
        <?php
            if(isset($_GET['loginError'])){echo "alert('Siz kiritgan login band. Boshqa login kiritib ko`ring');";}
            if(isset($_GET['newLogin'])){echo "alert('Yangi hodim kiritildi');";}
        ?>
    </script>
</head>
        ...
        <div class="row text-center " style="<?php if($UIns==='off'){echo 'display:none';} ?>">
            <div class="col-lg-12 col-12"  style="display:<?php if($Type==='mexmon'){echo 'none;';} ?>">
                <div class="info-box card px-2">
                    <div class="row">
                        <div class="col-lg-6">
                            <h5 class="card-title w-100 text-center m-0 p-0 mt-1 mb-2 pt-1">HODIMLAR</h5>
                        </div>
                        <div class="col-lg-6">
                            <button class="btn btn-primary my-1" style="border-radius: 0;" data-bs-toggle="modal" data-bs-target="#techerplus"><i class="bi bi-plus-square text-white" style="font-size:18px"></i> YANGI HODIM QO'SHISH</button>
                    ...
                    <table  class="table table-bordered text-center align-baseline table-striped" style="font-size:14px;" id="dataTable" width="100%" cellspacing="0">
                        <thead>
                            <tr class="align-middle">
                                ...
                                <th style="background-color: blue;color:white">Lavozim</th>
                                ...
                                foreach ($sql as $row) {
                                    if($row['Type']==='xisobchi'){
                                        echo "<tr>
                                            ...
                                            <td>".$row['Type']."</td>
                                            <td>
                                                <a href='./blog/hodim_edit.php?UserID=".$row['UserID']."' class='btn btn-success py-0 px-1 mr-2' style='border-radius: 0;"; if($UEdit==='off'){echo 'display:none';} echo "'>
                                                    <i class='bi bi-pencil-square' style='font-size:15px;color:white'></i>
                                                </a>
                                                <a href='./blog/hodim_eye.php?UserID=".$row['UserID']."' class='btn btn-danger py-0 px-1' style='border-radius: 0;'>
                                                    <i class='bi bi-eye-fill' style='font-size:15px;color:white'></i>
                                                </a>
                                            </td>
                                        </tr>"; $i++;                                        
                                    }elseif($row['Type']==='meneger'){
                                        echo "<tr>
                                            <td>".$i."</td>
                                            <td>".$row['FIO']."</td>
                                            <td>".$row['Phone']."</td>
